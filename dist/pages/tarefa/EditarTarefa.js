...
const EditarTarefa = ({ handleCloseEditar, idTarefaSelecionada, tarefas, tarefa, setTarefas }) => {
    ...
    const handleEditar = () => {
        ...
        setTarefas(current => current.map(obj => {
            if (obj.idTarefa === idTarefaSelecionada) {
                console.log('obj: ' + JSON.stringify(obj));
                return Object.assign(Object.assign({}, obj), { idTarefa: idTarefaSelecionada, tituloTarefa: tituloTarefa, descricaoTarefa: descricaoTarefa, inicioTarefa: inicioTarefa, fimTarefa: fimTarefa, recursoTarefa: recursoTarefa, statusTarefa: statusTarefa });
            }
            return obj;
        }));
    ...
    return (react_1.default.createElement(Grid_1.default, { container: true, spacing: 2 },
        react_1.default.createElement(Card_1.default, { sx: style },
            react_1.default.createElement(CardHeader_1.default, { title: "Tarefas", subheader: "Edi\u00E7\u00E3o de Tarefas" }),
                ...
                react_1.default.createElement(Grid_1.default, { container: true, spacing: 2, mt: 1 },
                    ...
                    react_1.default.createElement(Grid_1.default, { container: true, spacing: 2, pl: 2, mt: 2 },
                        react_1.default.createElement(Grid_1.default, { item: true, xs: 1 },
                            react_1.default.createElement(Button_1.default, { size: "small", variant: "contained", onClick: handleEditar }, "Salvar")),
                        react_1.default.createElement(Grid_1.default, { item: true, xs: 1 },
                            react_1.default.createElement(Button_1.default, { size: "small", variant: "outlined", onClick: handleCloseEditar }, "Cancelar"))))))));
};
const style = {
    position: 'absolute',
    top: '50%',
